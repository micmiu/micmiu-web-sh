 ...
 */
public interface GenericQueryDao<E, PK extends Serializable> extends GenericDao<E, PK> {
	 ...
	 * @return List<实体列表>
	 */
	public List<E> find(Map<String, Object> queryParams, LinkedHashMap<String, OrderType> orderParams);
